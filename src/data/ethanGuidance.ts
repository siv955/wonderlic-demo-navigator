// Gold-standard, Ethan-only demo guidance. Same shape as DEREK_GUIDANCE so the
// generic gold-standard detail component can render either. No em dashes in
// any user-facing copy.

export const ETHAN_GUIDANCE = {
  header: {
    name: "Ethan Miller",
    firstName: "Ethan",
    memoryHook: "Enterprising Ethan",
    primaryGap: "Low Enterprising Interest",
    story: "Relationship-first rep who struggles to close",
    developAnchor: "Enterprising Interest",
    teamDynamicsPath: "What Drives Us → Enterprising Interest",
    oneSentence:
      "Ethan is a relationship-first seller who builds trust and keeps prospects engaged, but struggles to create urgency, make the direct ask, and turn positive conversations into closed business.",
    useWhen: [
  ...
  runThisDemo: {
    ...
    develop:
      "Use Develop to help the manager coach the commercial behavior without asking Ethan to become pushy: connect the ask to helping the customer make a decision.",
    teamDynamics:
  ...
  coreStoryHelps: [
    {
      label: "Select",
      body: "Catch the person who may interview well because they are warm and relationship-oriented, but carry hidden risk for a role that requires commercial push.",
    },
    {
      label: "Develop",
      body: "If Ethan is already here, give the manager specific language to coach the behavior: creating urgency, making the ask, and helping the customer make a decision.",
    },
    {
      label: "Team Dynamics",
      body: "Help the manager understand what motivates different sellers, so the same sales outcome can be coached through different motivational paths.",
    },
  ],
  selectMoment: {
    purpose:
    ...
    storyTranslation:
      "For Ethan, the hiring question is not can this person build rapport. The question is: would this person look good enough in the interview because they are warm, likable, and relationship-oriented, but still carry the same commercial-drive risk that is already creating stalled pipeline?",
    ownWords: [
...
For Ethan, that might mean setting the expectation early: every opportunity needs a clear next step, every discovery call needs a decision question, and every proposal conversation needs a specific ask. You do not wait until the pipeline is full of nice conversations and soft next steps. You manage to the behavior from the beginning.`,
    ...
    caution: {
      dontSay: "This person will not close.",
      doSay: "This is a risk area to understand and probe before moving forward.",
    },
  },
  selectToDevelopTransition: `So that is the pre-hire version of Ethan.

But a lot of organizations already have Ethan on the team. And that is where the conversation changes.

We are no longer asking, "Should we hire Ethan?" We already did. Now the question is, "How do we help him turn positive customer conversations into real deal movement?"

And this is where I think Develop is really useful, because managers often know the behavior they are frustrated by, but they do not always know how to coach it specifically. They say things like, "be more aggressive," "create more urgency," or "you need to close harder."

That may be directionally true, but it is not very coachable.

Develop helps turn that into a more precise conversation: what is the specific commercial behavior, why does it matter in this role, and what action should the manager inspect?`,
  developMoment: {
    purpose:
    ...
    productBasics:
      "This is Ethan's Develop profile. The important shift is that we are not using this to decide whether to hire him. We are using it to help Ethan and his manager understand where he may naturally bring strengths, where parts of the role may take more intentional effort, and what behavior is most worth coaching next.",
    storyTranslation:
      "Ethan's development story is not that Ethan needs to become pushy. It is that Ethan may be strong at building trust, but the commercial ask takes more intentional effort. That matters in this role because the rep has to help the customer move from a positive conversation to a clear decision.",
    ownWords: [
...
That matters because sales behavior usually does not change because of one good feedback conversation. It changes because the manager keeps coming back to the same behavior: what ask did you plan, did you make it, what happened, and what will you do next time?`,
    ...
    valueTieBack:
      "This is where Wonderlic helps managers get more consistent commercial behavior out of the people they already chose. The value is not just the insight. It is the manager action that becomes easier: one ask, one next step, one way to inspect whether positive conversations are turning into real movement.",
    caution: {
      dontSay: "Ethan needs to become a different kind of person.",
      doSay: "For this role, Ethan needs a more consistent commercial behavior around urgency, direct asks, and next-step ownership.",
    },
  },
  developToTeamTransition: `So that is Ethan as one individual.

But managers do not manage one profile in isolation. They manage a team of sellers who may be motivated by different things and may need different coaching paths to reach the same sales outcome.

That is where Team Dynamics becomes helpful. It takes the same type of insight and gives the manager a way to understand what drives the broader team.`,
  teamDynamicsMoment: {
    purpose:
    ...
    storyTranslation:
      "At the individual level, Ethan is an Enterprising Interest story. At the team level, Enterprising Interest helps the manager think about motivation, commercial energy, and how different sellers may need different coaching to reach the same sales outcome.",
    ownWords: [
...
That is the value of Team Dynamics. It helps the manager stop coaching every seller with the same speech and start asking: what actually motivates this person to take the action the role requires?`,
    ...
    valueTieBack:
      "This helps managers stop guessing. Wonderlic gives them a clearer view of what drives the team, so they can coach commercial action in a way that fits the person while still holding the same standard for sales outcomes.",
    proxyNote: "",
    caution:
      "Do not say low Enterprising Interest means someone is not motivated. Say they may be motivated by different parts of the work, so the manager may need to connect the commercial action to the motivation that actually works for them. Do not make Team Dynamics about one outlier.",
  },
  fullClose: `So if I pull this all the way back up, Ethan is the same human pattern across the platform, but the use case changes.
...
For a team dealing with likable reps, positive conversations, soft next steps, and stalled opportunities, this gives you a way to catch the risk earlier and manage the behavior more consistently when it shows up.`,
  recap: {
    currentState: [
      "Reps can build positive customer relationships, but deals stall before a clear decision or next step.",
      "Managers struggle to tell whether the issue is skill, motivation, confidence, or lack of commercial urgency.",
      "Pipeline activity can look healthy while actual deal movement and closed business remain inconsistent.",
    ],
    futureState: [
      "Identify candidates more likely to combine relationship strength with the commercial drive the role requires.",
      "Give managers a more precise way to coach urgency, direct asks, and decision movement without relying on vague feedback like 'be more aggressive.'",
      "Help managers adapt coaching across the team so each seller can reach the same commercial outcome through the motivation that works for them.",
    ],
  },
  cautions: [
...
export type EthanGuidance = typeof ETHAN_GUIDANCE;
