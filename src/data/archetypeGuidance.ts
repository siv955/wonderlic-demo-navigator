...
export const ARCHETYPE_GUIDANCE: Record<ArchetypeId, ArchetypeGuidance> = {
  ...
  caleb: {
    ...
    teamDynamics: {
      ...
      whatToSay:
        "At the individual level, this is Caleb's communication story. At the team level, Compassion shows why the same message from him lands well with one teammate and erodes trust with another.",
      dontOverclaim:
  ...
  simon: {
    ...
    teamDynamics: {
      ...
      managerInsight:
        "Under pressure, some managers steady the team. Others transmit their pressure into the team. If Simon doesn't see the pattern, his team absorbs it, and his strong ICs may start looking elsewhere.",
      howToExplain:
    ...
    recap: {
      currentState: [
        ...
        "Strong ICs on the team may become frustrated and start looking elsewhere.",
      ],
      futureState: [
