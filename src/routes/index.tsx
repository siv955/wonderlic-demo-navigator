...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Find by Pain — Wonderlic Demo Story Finder" },
      {
        name: "description",
        content:
          "Type the customer's pain or pick a chip to get the right Wonderlic archetype, demo profile, and talk track.",
      },
      { property: "og:title", content: "Find by Pain — Wonderlic Demo Story Finder" },
      {
